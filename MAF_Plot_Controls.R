plotMAFs = function(xname, yname, xfile, yfile, removeBA=FALSE) {
	...
	x = paste("C://Users//Matt//Desktop//WorkplacePlink//", xfile, sep="")
	y = paste("C://Users//Matt//Desktop//WorkplacePlink//", yfile, sep="")
	...
	if (removeBA) {
		Con1.noNA = Con1.noNA[Con1.noNA$A1 != "B", ]
	}
...
#par(mfrow=c(2,1))
#plotMAFs("Case", "Con2", "CaseFreqs.frq", "Con2Freqs.frq")
#plotMAFs("Case Minus BAs", "Con2", "CaseFreqs.frq", "Con2Freqs.frq", removeBA=TRUE)
#title(main="Case-Control2 SNP MAF outliers are not simply the BA SNPs")